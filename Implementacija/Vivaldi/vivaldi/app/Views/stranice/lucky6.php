  ...
  <div class="container firstView">
    ...
    <div class="row" style="justify-content: center;">
      <div class="col-1">
        <div class="allRed"></div>
      </div>
      <div class="col-1">
        <div class="allGreen"></div>
      </div>
      <div class="col-1">
        <div class="allBlue"></div>
      </div>
      <div class="col-1">
        <div class="allPurple"></div>
      </div>
      <div class="col-1">
        <div class="allBrown"></div>
      </div>
      <div class="col-1">
        <div class="allYellow"></div>
      </div>
      <div class="col-1">
        <div class="allOrange"></div>
      </div>
      <div class="col-1">
        <div class="allGray"></div>
      </div>
    </div>
  ...
  <div class="container secondView">
    <div class="row">
      <div class="col-5">
      ...
      <div class="col-1">
        <div class="bubanj-balls">5</div>
        <div class="bubanj-balls">4</div>
        <div class="bubanj-balls">3</div>
        <div class="bubanj-balls">2</div>
        <div class="bubanj-balls">1</div>
      </div>
    </div><!-- row -->
    <div class="row">
